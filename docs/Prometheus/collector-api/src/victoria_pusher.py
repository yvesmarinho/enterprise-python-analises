...
# Métricas definidas no nível do módulo para evitar re-registro ao reiniciar
_ping_network_rtt = Gauge(
    'ping_network_rtt_milliseconds',
    'Network round-trip time in milliseconds',
    ['source_location', 'source_datacenter', 'source_country']
)

_ping_processing_time = Gauge(
...
class VictoriaPusher:
    ...
    def __init__(self):
        ...
        # Referências às métricas de módulo (sem re-registro)
        self.ping_network_rtt = _ping_network_rtt
        self.ping_processing_time = _ping_processing_time
