...
class PrometheusPusher:
    ...
    def push_metrics(self) -> bool:
        """
        Envia métricas para o Pushgateway de forma síncrona (usa httpx síncrono).
        Prefira push_metrics_async() em contextos assíncronos.
        """
        try:
    ...
    def delete_metrics(self) -> bool:
        ...
        try:
            ...
            logger.info("prometheus_metrics_deleted", url=url)
            return True
